...
func encrypt_block_128{bitwise_ptr : BitwiseBuiltin*}(input_state : felt, input_key : felt, s_box : felt*, mul_2 : felt*, mul_3 : felt*) -> (result : felt):
    alloc_locals
...
func decrypt_block_128{bitwise_ptr : BitwiseBuiltin*}(input_state : felt, input_key : felt) -> (result : felt):
    alloc_locals
...
func recursive_aes_128_encrypt{bitwise_ptr : BitwiseBuiltin*}(input : felt*, input_key : felt, array_length : felt, result : felt*, s_box : felt*, mul_2 : felt*, mul_3 : felt*) -> (result : felt*):
    if array_length == 0:
        return (result = result)
    end
    # here, we will put assertion for checking whether the input it bigger than 128 or not.
    let (out) = encrypt_block_128(input_state = input[0], input_key = input_key, s_box = s_box, mul_2 = mul_2, mul_3 = mul_3)
    
    assert result[0] = out

    return recursive_aes_128_encrypt(input = input + 1, input_key = input_key, array_length = array_length - 1, result = result + 1, s_box = s_box, mul_2 = mul_2, mul_3 = mul_3)
end

func aes_128_encrypt{bitwise_ptr : BitwiseBuiltin*}(input : felt*, input_key : felt, array_length : felt) -> (result : felt*):
    alloc_locals
    let (local s_box_empty : felt*) = alloc()
    ...
    let (result) = recursive_aes_128_encrypt(input = input, input_key = input_key, array_length = array_length, result = result, s_box = s_box, mul_2 = mul_2, mul_3 = mul_3)
...
func main{output_ptr : felt*, bitwise_ptr : BitwiseBuiltin*}():
    ...
    # TEST DATA
    #let (result) = encrypt_block_128(input_state = input_state, input_key = input_key)
    #let (result) = decrypt_block_128(input_state = input_dec_state, input_key = input_key)

    assert input[0] = 0x00112233445566778899aabbccddeeff
    assert input[1] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[2] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[3] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[4] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[5] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[6] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[7] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[8] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[9] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[10] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[11] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[12] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[13] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[14] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[15] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[16] = 0x00112233445566778899aabbccddeeff
    assert input[17] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[18] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[19] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[20] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[21] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[22] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[23] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[24] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[25] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[26] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[27] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[28] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[29] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[30] = 0x69C4E0D86A7B0430D8CDB78070B4C55A
    assert input[31] = 0x69C4E0D86A7B0430D8CDB78070B4C55A

    let (result) = aes_128_encrypt(input = input, input_key = input_key, array_length = 32)
